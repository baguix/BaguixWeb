...
/**
 * Description： 获得访客IP、浏览器类型等信息.
 * 
 * @author Scott
 * @since 1.0
 */

public class ClientInfoTool {
	...
	/**
	 * 通过淘宝IP库查询国家、省份、城市等实际地址
	 * 
	 * @param ip
	 * @return
	 */
	public static IpInfoBean getIpInfo(String ip) {
		...
		try {
			...
			if (obj.getIntValue("code") == 0) {
				...
				ipInfo.setIp(ip);
				ipInfo.setCountry(data.getString("country"));
				ipInfo.setArea(data.getString("region"));
