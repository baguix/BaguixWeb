...
<link rel="stylesheet" href="<%=request.getContextPath()%>/jslib/sctp/sctp/images/style.css?v=2">
...
<div id="cover"></div>
<script src="<%=request.getContextPath()%>/jslib/sctp/sctp/images/jquery-2.1.0.min.js"></script>
<script src="<%=request.getContextPath()%>/jslib/sctp/sctp/images/sonic.js"></script>
<script src="<%=request.getContextPath()%>/jslib/sctp/sctp/images/comm.js"></script>
<script src="<%=request.getContextPath()%>/jslib/sctp/sctp/images/hammer.js"></script>
<script src="<%=request.getContextPath()%>/jslib/sctp/sctp/images/iscroll-zoom.js"></script>
<script src="<%=request.getContextPath()%>/jslib/sctp/sctp/images/jquery.photoClip.js?v=1"></script>
<script>
var hammer = '';
var currentIndex = 0;
...
function saveImageInfo() {
	...
	$.post("<%=request.getContextPath()%>/mobileup.do", {image: img_data}, function (data) {
		if (data != '') {
//			console.info(data);
			//data 为返回文件名；
			alert('提交成功');
