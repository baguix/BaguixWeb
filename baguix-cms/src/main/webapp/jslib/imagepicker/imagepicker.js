...
(function() {
  ...
  ImagePickerOption = (function() {
	...
	ImagePickerOption.prototype.name = function() {
      if (this.option.data("img-src")) {
        return this.option.data("img-src");
      } else {
        return this.option.text();
      }
    };
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<li/>");
	  if(this.name().indexOf("_thumb")>0) {
        image = jQuery("<img class='image_picker_image_thumb'/>");
	  } else {
      ...
      if (this.opts.show_label) {
	    if(this.name().indexOf("thumb")>0) {
			thumbnail.append(jQuery("<div/>").html("<span class='labels'>(缩)"+this.label()+"</span>"));
		}
		else {
			thumbnail.append(jQuery("<div/>").html("<span class='labels'>(原)"+this.label()+"</span>"));
		}
      }
